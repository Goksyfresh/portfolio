# My Journey Building a Startup MVP

On a boring Thursday afternoon, a bright idea struck me. I sprang up from my couch, grabbed my journal and pen, and started writing. Within minutes, I was sitting by my “workspace”—or rather, my laptop on my lap, since I didn’t have a proper desk—and engaged ChatGPT to validate the thoughts in my head.  

Having recently learned the MERN stack, my first step was to ensure this app could be built with it—and yes, it could. I dove into planning the architecture and features of the app. The satisfaction that came with being the founder of a potential startup fueled my drive to make sure it saw the light of day.

---

## Backend Development

The backend took off almost immediately. I wrote schemas, handled authentication logic, and built endpoints to:
...
Of course, it wasn’t without bugs. What’s a coding session without hours lost debugging silly mistakes? Despite that, the backend was completed in a reasonable time.

In retrospect, if I were to start over, I might reconsider using MongoDB and lean towards a backend-as-a-service. Incorporating Google Sign-In and Apple Sign-In into a MERN app proved challenging, and these integrations could have provided a better user experience for signing up quickly.
...
I was dejected. Despite pouring blood, sweat, and tears into this product, I didn’t have active users. But the experience was invaluable. I learned lessons about:
